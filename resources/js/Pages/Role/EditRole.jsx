...
export default function EditRole({props, roleId, permissions}) {
		...
		<section className="absolute inset-0 top-0 left-0 right-10 bottom-0 h-screen overflow-x-hidden w-screen z-40 bg-gray-500/50">
			<div className="relative flex mx-auto py-10">
				<div className="flex w-auto h-auto mx-auto p-10">
					...
					<div className="py-3">
						<div className="mb-3">
							<label htmlFor="role_title" className="border-b border-gray-300 text-md text-gray-700 font-bold block my-2.5">Change Title</label>
							<input 
								id="role_title" 
								type="text" 
