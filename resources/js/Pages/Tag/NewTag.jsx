...
export default function NewTag({props, visibility}) {
		...
		<section className="absolute inset-0 top-0 left-0 right-10 bottom-0 h-full overflow-hidden w-screen z-40 bg-gray-500/50">
			<div className="relative flex mx-auto py-10">
				<div className="flex w-auto h-auto mx-auto p-10">
					...
					<h2 className="text-center text-2xl text-zinc-500 border-b border-slate-300 my-3 font-bold">New Tag</h2>
					<div className="py-3">
						<div className="mb-3">
							<label htmlFor="tag_name" className="border-b border-gray-300 text-md text-gray-700 font-bold block my-2.5">Name <span className="text-red-500">*</span></label>
							<input 
								id="tag_name" 
								type="text" 
								value={data.tag_name} 
