...
export default function EditProject({props, id, categories}) {
	...
	function submit(e) {
		e.preventDefault()
		if(data.project_description != null) data.project_description = draftToHtml(convertToRaw(editorState.getCurrentContent()))
	...
	return <>
		{(visible || (errors.project_title != null || errors.project_description != null || errors.project_link != null)) && 
			<section className="absolute inset-0 top-0 left-0 right-10 bottom-0 h-full overflow-hidden w-screen bg-gray-500/50 z-40">
				<div className="relative flex py-10">
				<form onSubmit={submit} className="mx-auto bg-white drop-shadow-xl w-auto h-auto rounded-sm px-10 py-5">
					<h2 className="text-center text-2xl text-zinc-500 border-b border-slate-300 my-3 font-bold">Updating Project ID: {id}</h2>
					<div className="py-3">
						<div className="flex mb-3 space-x-3">
							<div className="flex-1">
								<label htmlFor="project_title" className="border-b border-gray-300 text-md text-gray-700 font-bold block my-2.5">Change Project Title</label>
								<input 
									id="project_title" 
									type="text" 
							...
							<div className="flex-1">
								<label htmlFor="project_link" className="border-b border-gray-300 text-md text-gray-700 font-bold block my-2.5">Change Project Link</label>
								<input 
									id="project_link" 
									type="text" 
						...
						<div className="mb-3">
							<label htmlFor="project_description" className="border-b border-gray-300 text-md text-gray-700 font-bold block my-2.5">Change Project Description</label>
							<Editor 
						...
						<div className="flex mb-3 space-x-3">
							...
							<div className="flex-1">
								<label htmlFor="project_category_id" className="border-b border-gray-300 text-md text-gray-700 font-bold block my-2.5">Change Project Category</label>
								<select
							...
							<div className="flex-1">
							<label htmlFor="image_url" className="block border-b border-gray-300 text-md text-gray-700 font-bold block my-2.5">Change Uploaded Image</label>
							<input 
								id="image_url" 
								type="file"
								name="image_url" 
						...
						<div className="relative flex mx-auto text-center pb-4">
							<Link href="/projects" className="flex-1 transition delay-50 px-4 py-2 text-md- font-medium bg-slate-600 hover:bg-slate-400 text-slate-50 rounded-l-sm" as="button" type="submit">Back</Link>
